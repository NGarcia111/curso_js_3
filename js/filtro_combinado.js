...
const categoriasBtn = categorylist.map(categoria => {
    return `<li><button class="category-btn" onclick="seleccionarCategoria('${categoria}')">${categoria}</button></li>`;
});
...
buscador.addEventListener("input", mostrarBoton); // Es ineficiente para muchos datos